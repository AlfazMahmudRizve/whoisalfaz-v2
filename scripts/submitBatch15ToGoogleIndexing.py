...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch15_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 15 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 15 Google Indexing submissions complete.")
