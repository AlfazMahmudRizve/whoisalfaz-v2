...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch7_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 7 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 7 Google Indexing submissions complete.")
