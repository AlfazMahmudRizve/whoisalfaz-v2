...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch6_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 6 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 6 Google Indexing submissions complete.")
