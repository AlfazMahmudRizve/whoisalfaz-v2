...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch8_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 8 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 8 Google Indexing submissions complete.")
