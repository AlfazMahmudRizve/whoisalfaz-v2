...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch18_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 18 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 18 Google Indexing submissions complete.")
