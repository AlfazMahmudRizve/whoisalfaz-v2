...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch10_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 10 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 10 Google Indexing submissions complete.")
