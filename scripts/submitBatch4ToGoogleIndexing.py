...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch4_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 4 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 4 Google Indexing submissions complete.")
