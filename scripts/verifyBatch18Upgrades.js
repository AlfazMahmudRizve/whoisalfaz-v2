...
console.log('=== VERIFYING BATCH 18 UPGRADES ===\n');

let allPassed = true;

batch18Slugs.forEach(slug => {
  const filePath = `scratch/batch18_upgraded_${slug}.json`;
...
if (allPassed) {
  console.log('🎉 ALL BATCH 18 POSTS PASSED AUDIT CRITERIA STRICTLY!\n');
} else {
