...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch3_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 3 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 3 Google Indexing submissions complete.")
