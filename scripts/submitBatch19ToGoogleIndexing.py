...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch19_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 19 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 19 Google Indexing submissions complete.")
