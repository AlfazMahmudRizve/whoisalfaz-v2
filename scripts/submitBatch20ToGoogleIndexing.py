...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch20_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 20 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 20 Google Indexing submissions complete.")
