...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch21_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting FINAL Batch 21 Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n🎉 Batch 21 Google Indexing complete. All 105 posts submitted!")
