...
const workflow = {
  ...
  "versionId": "c1f7a01a-0004-4000-8000-000000000001",
  "meta": {
...
console.log('✅ Fixed ManyChat template with 100% strict n8n v1/v2 node parameters!');
