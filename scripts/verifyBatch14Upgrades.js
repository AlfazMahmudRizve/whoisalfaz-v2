...
console.log('=== VERIFYING BATCH 14 UPGRADES ===\n');

let allPassed = true;

batch14Slugs.forEach((slug, idx) => {
  const filePath = `scratch/batch14_${slug}_upgraded.json`;
...
if (allPassed) {
  console.log('🎉 ALL BATCH 14 POSTS PASSED RIGOROUS VERIFICATION!');
} else {
