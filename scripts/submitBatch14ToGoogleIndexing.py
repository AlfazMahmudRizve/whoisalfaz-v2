...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch14_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 14 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 14 Google Indexing submissions complete.")
