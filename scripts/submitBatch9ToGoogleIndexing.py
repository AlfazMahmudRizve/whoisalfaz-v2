...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch9_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 9 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 9 Google Indexing submissions complete.")
