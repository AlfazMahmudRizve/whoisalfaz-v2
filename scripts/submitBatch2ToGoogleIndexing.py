...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch2_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 2 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 2 Google Indexing submissions complete.")
