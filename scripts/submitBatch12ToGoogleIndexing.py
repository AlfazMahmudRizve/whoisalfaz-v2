...
] + [f"https://whoisalfaz.me/blog/{s}/" for s in batch12_slugs]
...
try:
    print("=" * 75)
    print("🚀 Submitting Batch 12 Upgraded Articles to Google Indexing API")
    print("=" * 75)
    ...
    print("\n✅ Batch 12 Google Indexing submissions complete.")
