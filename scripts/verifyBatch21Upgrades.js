...
console.log('=== VERIFYING BATCH 21 UPGRADES (FINAL BATCH) ===\n');

let allPassed = true;

batch21Slugs.forEach(slug => {
  const filePath = `scratch/batch21_upgraded_${slug}.json`;
...
if (allPassed) {
  console.log('🎉🎉🎉 ALL BATCH 21 POSTS PASSED — 105/105 ARTICLES VERIFIED! MISSION COMPLETE! 🎉🎉🎉\n');
} else {
