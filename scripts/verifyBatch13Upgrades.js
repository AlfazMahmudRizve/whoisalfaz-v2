...
console.log('=== VERIFYING BATCH 13 UPGRADES ===\n');

let allPassed = true;

batch13Slugs.forEach((slug, idx) => {
  const filePath = `scratch/batch13_${slug}_upgraded.json`;
...
if (allPassed) {
  console.log('🎉 ALL BATCH 13 POSTS PASSED RIGOROUS VERIFICATION!');
} else {
