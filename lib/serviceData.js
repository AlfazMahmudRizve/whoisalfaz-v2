...
export const serviceData = {
    ...
    "headless-architecture": {
        ...
        detailedContent: [
            ...
            "This isn't just a website; it's a software-grade platform. By hosting the frontend on the Edge and optimizing data retrieval — as detailed in our [Pinecone vs Qdrant benchmark on Vultr](/blog/pinecone-vs-qdrant-vultr-benchmark/) — we deliver sub-second response times and zero downtime for modern businesses."
        ]
    },
    "growth-consulting": {
        ...
        detailedContent: [
            ...
            "We partner with you to dissect your current operations, from your tech stack to your team's SOPs. We help agency founders transition to the high-ticket [AI automation agency business model](/blog/ai-automation-agency-business-model/) — eliminating manual bottlenecks, streamlining client onboarding, and unlocking sustainable retainers.",
    ...
    "technical-seo": {
        ...
        subtitle: "Stop guessing why your traffic dropped. Get a deep forensic technical SEO analysis of your site's code, crawlability, and JavaScript rendering performance to fix invisible ranking errors.",
        price: "$350",
        ...
        detailedContent: [
            ...
            "We perform a forensic audit of your website's code, structure, and indexability. We check Crawl Budget, JavaScript rendering, Canonical tags, Hreflang implementation, and internal linking structures. For fast, zero-install crawls, explore our [free Screaming Frog alternative](/blog/screaming-frog-alternatives-free-seo-audit-tools/) guide to diagnose site-wide crawl bottlenecks without DNS gates.",
    ...
    "custom-full-stack": {
        ...
        detailedContent: [
            ...
            "As a Full-Stack Architect, I design and build custom web applications tailored exactly to your workflow. Whether it's a client portal that auto-updates from your CRM, a bespoke project management dashboard, or a complex AI data pipeline built for the [AI automation agency business model](/blog/ai-automation-agency-business-model/), I engineer it from the ground up using Next.js and robust backend logic.",
