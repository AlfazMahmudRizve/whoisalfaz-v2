...
export const serviceData = {
    "n8n-automation": {
        ...
        detailedContent: [
            ...
            "We build robust, custom AI-powered workflows that handle your operations on autopilot. Unlike Zapier, which can get expensive and restrictive at scale, we utilize n8n to offer enterprise-grade flexibility. We can engineer complex flows that scrape data, enrich leads via Apollo, qualify them with AI, and sync everything to your CRM instantly — see how this fits together in our deep dive into **[ManyChat Pricing & Stack Integration](/blog/manychat-pricing-2026/)**.",
